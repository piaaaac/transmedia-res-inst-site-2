...
function increaseEasterInteractions (amt = 1) {
  ...
  if (interactions > nextAppearance) {
    ...
    // easterEl.style.fontSize = easterFS + "px";
    // easterEl.style.fontSize = (Math.random() < 0.1) ? "11px" : easterFS + "px";
    // easterEl.style.opacity = Math.random() * Math.random() * Math.random();
    easterEl.style.opacity = easterOp;
    // setTimeout(() => { easterEl.style.opacity = 0; }, 3000);
  }
