...
void main() {
  ...
  gl_FragColor = texture2D(originalImage, uv + mouse*vec2(1.0, 1.0) * depth.r); // LARGE
  //gl_FragColor = texture2D(originalImage, uv + mouse*vec2(0.1, 0.05) * depth.r); // SMALL
...
let imgs = [
  {img: "dall-e-59.png", depthMap: "dall-e-59-map.png"},
  // {img: "mid-organic_solarpunk.png", depthMap: "mid-organic_solarpunk-map.png"},
