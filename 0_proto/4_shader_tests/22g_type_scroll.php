...
function setup () {
  ...
  canvas.parent(cont);
  cont.position(random(windowWidth-w), random(windowHeight-h), "fixed");
  cont.style("height", h - 90 + "px");
  // cont.elt.position();
  ...
  imgTypography.text(text, width*0.2, height*1.2, width*0.6, height*3.0);
}
