  ...
  <body>
    ...
    <script type="module">
      ...
      function init() {
        ...
        // via https://dev.to/maniflames/pointcloud-effect-in-three-js-3eic
        let material = new THREE.PointsMaterial({ color: 0xFFFFFF, size: 0.00000025 })
        // let mesh = new THREE.Points(object.children[0].geometry, material)

        const manager = new THREE.LoadingManager(function modelLoaded () {
